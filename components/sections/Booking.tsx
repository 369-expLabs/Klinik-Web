        ...
        <div className="grid lg:grid-cols-5 gap-8 items-stretch">
          ...
          <div className="lg:col-span-3 premium-glass-dark p-8 md:p-12 relative overflow-hidden flex flex-col justify-between">
            ...
            <a
              ...
              className="relative z-10 w-full flex items-center justify-center gap-3 bg-forest hover:bg-forest-light text-cream font-semibold py-4 md:py-5 rounded-2xl transition-all font-satoshi text-base shadow-[0_0_20px_rgba(33,67,38,0.5)] animate-[pulseGlow_2.5s_ease-in-out_infinite]"
            >
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="bg-sage/10 border border-sage/20 rounded-3xl p-8 backdrop-blur-sm">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-gold font-satoshi text-sm font-semibold hover:text-gold-light transition-colors group"
              >
                Tanya Dulu via WA
