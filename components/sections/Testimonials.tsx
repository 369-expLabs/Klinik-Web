        ...
        <div className="grid md:grid-cols-3 gap-6">
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <p className="text-sm text-charcoal-soft font-dm leading-relaxed italic flex-1 mb-6">
                {t.quote}
              </p>
              <div className="border-t border-cream-dark pt-5">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-semibold text-charcoal font-dm">{t.initial}</p>
                    <p className="text-xs text-taupe font-dm">{t.age} · {t.problem}</p>
                  </div>
                  <span className="bg-sage/10 text-sage-dark text-xs font-semibold px-3 py-1 rounded-full font-dm">
                    {t.sessions}
                  </span>
                </div>
              </div>
